...
*/
  ...
  CArchiveCommandLineOptions options; //These seems to be 7zip functions
  ...
  CStdOutStream &stdStream = options.StdOutMode ? g_StdErr : g_StdOut; // guess this selects the output stream, stdout or stderr
